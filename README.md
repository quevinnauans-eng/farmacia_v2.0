...
O projeto foi desenvolvido durante o início da disciplina de Estrutura de Dados no IFBA Campus Irecê,
com foco em prática de modularização, manipulação de arquivos, alocação dinâmica de memória
...
O objetivo do projeto foi praticar conceitos fundamentais da linguagem C
e da disciplina de Estrutura de Dados, incluindo manipulação de memória, modularização
e persistência de dados utilizando arquivos.
